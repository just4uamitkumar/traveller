...
const Banner = () => {
    ...
    const [cities, setCities] = useState<string[]>(['Los Angeles', 'Chicago',
        'Houston', 'Dallas', 'San Jose', 'Fort Worth']);

    const [stateList, setStateList] = useState(['New York', 'Illinois',
            ...
            <div className="banner">
                <div className="container clearfix">
                    <div className="advtSection">
                        ...
                        <div className="advtCont">
                            ...
                            <p>Use one card for travel, dining, shopping, hotels,hotels and entertainment</p>
                        </div>
                ...
                <div className="bannerBottom">
                    <div className="titleSection">
                        <h2 className="text-center">MULTI-CURRENCY<br />FOREX CARD</h2>
                    </div>
